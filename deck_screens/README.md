# DANA Sahabat Warung — Deck UI Screen Captures

Seluruh gambar di folder ini berformat PNG resolusi tinggi dengan ukuran standar frame layar smartphone (**375 × 812 px**, *pure mobile frame* tanpa mockup luar/desktop), siap disalin dan dimasukkan langsung ke slide presentasi (Figma, Canva, Google Slides, PowerPoint).
...
6b. `3_1_6b_hub_beranda_scrolled_rian.png` — **Beranda Mini Program Scrolled Mentok ke Bawah (Rian - Konsumen):** Tampilan bawah beranda: Box kode referral `HAF58W`, tombol CTA *"Bantu Daftarkan Warung Langganan"*, skema reward Saldo DANA Rp35.000 (Rp5.000 Tahap 1 + Rp30.000 Tahap 2), dan card Hadiah Pencapaian Rp1.000.000.
6c. `3_1_6c_hub_beranda_scrolled_putu.png` — **Beranda Mini Program Scrolled Mentok ke Bawah (Bu Putu - Merchant):** Tampilan bawah beranda: Box kode referral `HAF58W`, tombol CTA *"Bantu Daftarkan Rekan Usaha"*, skema reward operasional Kupon Bebas Transfer 2x & Bebas Admin 10x, dan card Hadiah Pencapaian Rp1.000.000.
...
10. `3_3_1_reward_consumer.png` — **Tab Reward Konsumen (Rian):** Saldo DANA Rp35.000 (Rp5.000 Tahap 1 + Rp30.000 Tahap 2) cair otomatis ke Saldo Pocket DANA.
11. `3_3_2_reward_merchant.png` — **Tab Reward Mitra Bisnis (Bu Putu):** Kupon operasional usaha: Bebas Biaya Transfer (2x) & Bebas Admin Transaksi (10x).
...
22. `3_4_6_qris_verification_modal.png` — **Modal Verifikasi Meja Kasir (Tahap 2):** Tampilan modal verifikasi fisik foto standee kasir terpasang, validasi lokasi toko (`GPS MATCH ✓`), rincian reward terbuka (Kupon 10x Bebas Admin Pak Joko & Saldo Rp30.000 / Kupon 10x Pengundang), dan tombol konfirmasi klaim Tahap 2.
